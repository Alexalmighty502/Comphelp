...
currentpc = {
    ...
    "answers": {"yes": virusandmalware,
                "no": "An operating system like windows is very complex and requires a lot of loading from Storage to Ram and back to the storage. Upgrading from a HDD to SSD will make the system in all feel much more responsive I HIGHLY recommend to replace your HDD to an SSD"}
}
agetest = {
...
isitslow = {
    "question": "Is the pc slow or unresponsive?",
    "answers": {"yes": currentpc, "no": blank}
}
boots = {
    "question": "Is your pc stable but slow or does it crash? (print stable or crash)",
    "answers": {"stable": isitslow, "crash": itscrashy}
}
powertrip = {
